...
// Auto-connect if kiosk_id is in the URL (e.g., ?kiosk_id=kiosk_001&location=library)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] flex items-center justify-center p-4">
      {/* User Header */}
      <header className="absolute top-0 left-0 right-0 bg-[#0f172a]/95 backdrop-blur-md border-b border-[#334155] z-10 py-0.4 px-6">
      ...
      <div className="flex items-center justify-center px-4 py-8">
        <Card className="w-full max-w-md mt-12 bg-card/90 backdrop-blur-xl border border-border shadow-2xl rounded-3xl">
